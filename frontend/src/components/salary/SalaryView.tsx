...
export function SalaryView() {
  ...
  return (
    <AppShell>
      ...
      >
        <h1 className="mb-6 pt-2 text-3xl font-semibold md:text-4xl">Зарплаты</h1>
        ...
        <div className="mt-7 flex flex-wrap items-end justify-between gap-3">
          ...
          <div className="text-md text-fg-muted">
            Фонд: <span className="font-semibold text-fg">{formatRub(fund)} ₽</span>
            <span className="mx-2">·</span>
            Ждут выплаты:{" "}
            <span className="font-semibold text-accent">{pendingCount}</span>
          </div>
        </div>
        <div className="mt-4">
